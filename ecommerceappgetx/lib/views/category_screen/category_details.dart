...
class _CategoryDetailsState extends State<CategoryDetails> {
  ...
  void initState() {
    ...
    super.initState();
    swtichCategory(widget.title);
  }

  swtichCategory(title){
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(productController.subcat.length,
                          (index) => "${productController.subcat[index]}".text.size(12).fontFamily(semibold)
                          .color(darkFontGrey).makeCentered().box.white
                          .rounded.size(120, 50)
                          .margin(const EdgeInsets.symmetric(horizontal: 4))
                              .make().onTap(() {
                                swtichCategory("${productController.subcat[index]}",);
                                setState(() {
                                  ...
                                  itemBuilder: (context, index){
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        .roundedSM.outerShadowSm.padding(const EdgeInsets.all(12))
                                        .make().onTap(() {
